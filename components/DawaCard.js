...
const DawaCard = ({ item }) => {
  ...
  return (
    <TouchableOpacity style={{ flex: 1, alignItems: 'center', backgroundColor: '#f8f8f8', padding: 20,borderRadius: '10%', marginTop: 2.5, marginBottom: 2.5, marginLeft: 5, marginRight: 5 }}>
